...
/**
 * Consumes Contacts objects from the configuration file
 * and exports data from the specified contacts element to a file.
 * @author bwa-
 */
public class ContactConsumer implements Consumer<Contacts> {
	 ...
	 * @param username Name of user that owns the contacts
	 * @param password Password of user
	 * @param settings Settings element (from the configuration file)
	 */
	public ContactConsumer(String username, String password, Settings settings) {
